...
public class AnalysisHierarchy {
    ...
    public static void main(String[] args) throws IOException {
        String OUTPUT_DIR = "E:\\downloads\\SC_HW\\hw6\\static-analysis\\output";
        try {
            ...
            String casspath = "E:\\downloads\\SC_HW\\hw6\\static-analysis\\data\\apache-cassandra-4.2-SNAPSHOT.jar";
            AnalysisScope scope =
